 ...
 *
 */
@Service("momoRegistrationTokenService")
public class MomoRegistrationTokenService<E extends RegistrationToken, D extends RegistrationTokenDao<E>>
	...
	public MomoRegistrationTokenService() {
	 ...
	 */
	protected MomoRegistrationTokenService(Class<E> entityClass) {
		super(entityClass);
	}
	 ...
	 */
	@Autowired
	@Qualifier("registrationMailMessageTemplate-mn")
	private SimpleMailMessage registrationMailMessageTemplateMongolian;
	...
	public void sendRegistrationActivationMail(HttpServletRequest request,
		...
		if (lang.equals("de")) {
			...
			registrationActivationMsg = new SimpleMailMessage(
					getRegistrationMailMessageTemplateMongolian()
			);
		} else {
			registrationActivationMsg = new SimpleMailMessage(
	...
	/**
	 * @return the registrationMailMessageTemplateMongolian
	 */
	public SimpleMailMessage getRegistrationMailMessageTemplateMongolian() {
		return registrationMailMessageTemplateMongolian;
	}

	/**
	 * @param registrationMailMessageTemplateMongolian the registrationMailMessageTemplateMongolian to set
	 */
	public void setRegistrationMailMessageTemplateMongolian(SimpleMailMessage registrationMailMessageTemplateMongolian) {
		this.registrationMailMessageTemplateMongolian = registrationMailMessageTemplateMongolian;
	}
